...
import { BarChart3, LineChart, Activity, Heart, Dna, Stethoscope, ShieldAlert } from 'lucide-react';
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              ...
              >
                <TabsList className="grid grid-cols-2 md:grid-cols-4 gap-2 p-1 backdrop-blur-md bg-card/30 border border-[#15E3E3]/10 rounded-xl">
