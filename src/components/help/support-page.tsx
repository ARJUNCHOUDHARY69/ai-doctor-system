      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <Card className="bg-background/80 backdrop-blur-md border-0 shadow-xl">
          <CardHeader className="text-center pb-2">
            ...
            <CardDescription className="text-muted-foreground">Get the help you need with AI Doctor System</CardDescription>
          </CardHeader>
            ...
            <Tabs defaultValue="help" className="w-full">
              ...
              <TabsContent value="help" className="pt-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="text-muted-foreground mb-4">
                        <p>Find quick answers to common questions about using AI Doctor System, subscription plans, and more.</p>
                      </div>
                      <Link href="/help/faq">
              ...
              <TabsContent value="guides" className="pt-6">
                <div className="grid grid-cols-1 gap-6">
                  <Card>
                    <CardHeader className="pb-2">
                      <CardTitle className="text-xl">Getting Started with AI Doctor System</CardTitle>
                      <CardDescription>A comprehensive guide to help you get the most out of AI Doctor System</CardDescription>
                    </CardHeader>
                    <CardContent>
                      ...
                      <div>
                        ...
                        <div className="space-y-3 text-muted-foreground">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <p>Email: support@aidoctor.com</p>
                          </div>
                        </div>
