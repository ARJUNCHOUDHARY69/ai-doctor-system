        ...
        <Card className="bg-background/80 backdrop-blur-md border-0 shadow-xl">
          <CardHeader className="text-center pb-2">
            ...
            <CardDescription className="text-muted-foreground">
              Find answers to the most common questions about AI Doctor System
            </CardDescription>
          </CardHeader>
          <CardContent className="pt-6">
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                <AccordionTrigger className="text-lg font-medium">What is AI Doctor System?</AccordionTrigger>
                <AccordionContent className="text-muted-foreground">
                  AI Doctor System is an AI-powered healthcare platform that bridges healthcare gaps in rural communities.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-2">
                <AccordionTrigger className="text-lg font-medium">
                  How does AI Doctor System help with preventive healthcare?
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground">
                  AI Doctor System provides early warning indicators for potential health issues, personalized health insights
              ...
              <AccordionItem value="item-5">
                <AccordionTrigger className="text-lg font-medium">
                  Can I use AI Doctor System with my fitness tracker?
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground">
                  Yes, AI Doctor System integrates with Google Fit, allowing you to import data from compatible fitness trackers.
