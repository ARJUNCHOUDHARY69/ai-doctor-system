      ...
      <div className="mx-auto max-w-7xl px-8">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex flex-col gap-4">
            <h3 className="text-lg font-semibold mb-2">AI Doctor System</h3>
            <p className="text-muted-foreground text-sm mb-4">
              Bridging healthcare gaps in rural communities through intelligent AI solutions that provide accessible medical assistance.
            </p>
        ...
        >
          <motion.div variants={itemVariants} className="flex flex-wrap justify-center gap-6">
            ...
            <div>© {new Date().getFullYear()} AI Doctor System. All rights reserved.</div>
          </motion.div>
        </motion.div>
      </div>
    </footer>
