...
export const metadata: Metadata = {
  ...
  description:
    'AI Doctor System – Bridging Healthcare Gaps in Rural Communities. An intelligent healthcare platform providing medical assistance, health monitoring, and personalized care for underserved communities.',
};
